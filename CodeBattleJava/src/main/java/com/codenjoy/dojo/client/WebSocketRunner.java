...
import com.codenjoy.dojo.tetris.client.UrlParser;
...
public class WebSocketRunner<T extends ClientBoard> implements Closeable {
    ...
    public WebSocketRunner(Solver<T> solver, T board) {
        this.solver = solver;
        this.board = board;
        this.forceClose = false;
    }

    public static <T extends ClientBoard> WebSocketRunner<T> runClient(String url, Solver<T> solver, T board) {
    ...
    public static <T extends ClientBoard> WebSocketRunner<T> runAI(String aiName, String code, Solver<T> solver, T board) {
    ...
    private static <T extends ClientBoard> WebSocketRunner<T> run(String protocol,
                                       String server, String context,
                                       String userName, String code,
                                       Solver<T> solver, T board,
                                       int countAttempts) {
    ...
    public static <T extends ClientBoard> WebSocketRunner<T> run(URI uri, Solver<T> solver, T board, int countAttempts) {
        try {
            WebSocketRunner<T> client = new WebSocketRunner<>(solver, board);
